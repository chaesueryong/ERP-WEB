    ...
    <div className="Orders">
      ...
      <div className='grid-box'>
        ...
        >
          ...
          <Column dataField="발주수량" />
          <Column dataField="입고수량" />
          <Column dataField="발주대금" />
          
          <Column caption="*발주대금 결제">
            <Column
              dataField=""
              caption="현금"
              format="fixedPoint"
