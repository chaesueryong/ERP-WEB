      ...
      <div className='grid-box'>
        <div className='list-button'>
          <div className='list-button-left'>
            <ButtonNormal name='상품 등록' bg_color='#495057' font_weight='400' color='white' handleClick={toggleModal} />
            <ButtonNormal name='상품 발주/반품' bg_color='#495057' font_weight='400' color='white' handleClick={toggleModal} />
          </div>
        ...
        >
          ...
          <Column dataField="제품사진" />
          <Column dataField="*상품명" />
          <Column dataField="상품 분류" />
          <Column dataField="컬러" />
          <Column dataField="사이즈" />
          <Column dataField="시즌" />
          <Column dataField="입고수량" />
          <Column dataField="판매수량" />
          <Column dataField="현재재고" />
          <Column dataField="마지막 입고일자" />
        </DataGrid>
      </div>
