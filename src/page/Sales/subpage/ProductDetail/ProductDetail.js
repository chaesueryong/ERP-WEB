...
import { Column, HeaderFilter, Search, Selection } from 'devextreme-react/data-grid';
...
const filters = [
    ...
    {name: '상품 분류', value: 'brand_cnt', checked: true},
    {name: '컬러', value: 'owener', checked: true},
    {name: '사이즈', value: 'owener_phone', checked: true},
    {name: '공급가', value: 'manager', checked: true},
    {name: '판매가', value: 'manager_phone', checked: true},
    {name: '판매량', value: 'l_address', checked: true},
    {name: '반품량', value: 'c_account', checked: true},
    {name: '현금 매출', value: 'c_account', checked: true},
    {name: '카드 매출', value: 'c_account', checked: true},
    {name: '순매출', value: 'c_account', checked: true},
