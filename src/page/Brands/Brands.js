      ...
      <div className='grid-box'>
        <div className='list-button'>
          <div className='list-button-left'>
            <ButtonNormal name='브랜드 등록' bg_color='#495057' font_weight='400' icon={true} color='white' handleClick={toggleModal} />
        ...
        >
          ...
          <Column dataField="상품 카테고리" />
          <Column dataField="제품유형" />
          <Column dataField="등록일자" />
        </DataGrid>
      </div>
